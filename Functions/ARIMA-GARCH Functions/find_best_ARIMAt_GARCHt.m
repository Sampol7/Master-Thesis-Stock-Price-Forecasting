% Function that selects most promising ARIMA-t-GARCH-t model based on maximal p-value, AIC,
% and correlation in residuals
 
function best_pqAG = find_best_ARIMAt_GARCHt(train_logclose, results_ARIMAt_GARCHt_p1q)
...
for tolerance = tolerances
    ...
    filtered_results = filter_by_pvalueAG(results_ARIMAt_GARCHt_p1q, tolerance);
