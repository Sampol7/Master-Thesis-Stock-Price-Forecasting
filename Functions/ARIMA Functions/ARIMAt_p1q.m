%Function to calculate maximal p-value and AIC for all ARIMA-t(p_A,1,q_A) models in (p_A,q_A) \in [0,max_pq] x [0,max_pq] grid.

function results = ARIMAt_p1q(time_series, max_pq)
